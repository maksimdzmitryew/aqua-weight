...
export default function DateTimeLocal({ form, name, label, disabled, required, validators, ...rest }) {
  ...
  return (
    <div>
      ...
      <input id={name} type="datetime-local" disabled={disabled} aria-invalid={!!error} aria-describedby={error ? `${name}-error` : undefined} required={required} {...reg} {...rest} style={inputStyle} />
