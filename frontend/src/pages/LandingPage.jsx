  ...
  return (
    <div className="bg-surface font-body-md text-on-surface selection:bg-secondary-container selection:text-on-secondary-container">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-surface/80 dark:bg-on-background/80 backdrop-blur-md border-b border-outline-variant/30 shadow-sm px-margin-mobile md:px-margin-desktop py-4">
        <div className="max-w-container-max mx-auto flex justify-between items-center h-12">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <a
              className="font-label-caps text-label-caps text-secondary dark:text-secondary-fixed-dim border-secondary"
              href="#features"
            >
              Features
            </a>
      ...
      <main className="overflow-x-hidden">
          ...
          <div className="max-w-container-max mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-stack-lg items-center w-full">
            <div className="flex flex-col gap-6 max-w-[736px]" data-aos="fade-right">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <Link
                  to="/login"
                  className="bg-primary text-on-primary font-label-caps text-label-caps px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:translate-y-[-2px] flex items-center gap-2"
                >
        ...
        <section
          id="features"
          className="bg-surface-container-low px-margin-mobile md:px-margin-desktop py-stack-lg"
        >
          <div className="max-w-container-max mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-4">
                Smart Watering for Every Scenario.
              </h2>
              <p className="text-on-surface-variant max-w-2xl mx-auto">
                Choose the mode that fits your lifestyle. Our intelligent gravity-sensing base
                handles the rest.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-gutter">
              {/* Card 1: Automatic */}
              <div
                className="glass-card p-8 rounded-[24px] flex flex-col gap-4 group hover:border-secondary/50 transition-colors"
                style={{
              ...
              >
                ...
                <div>
                  ...
                  <div>
                    <i>
                      Be reminded of watering exactly when needed by each plant individually. Our
                      algorithms detect precise moisture evaporation through weight loss.
                    </i>
                  </div>
                </div>
                <div className="mt-auto pt-6">
                  ...
                  <div className="mt-4">
                    ...
                    <span className="font-label-sm text-label-sm text-secondary mt-2 inline-block">
                      99% Accuracy Gain 24/7
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div>
                    <i>
                      Get immediate real-time watering suggestion specific to each plant as soon as
                      its weight is entered manually by owner or a helping person.
                    </i>
                  </div>
                </div>
                <div className="mt-auto pt-6">
              ...
              >
                ...
                <div>
                  <i>
                    Receive gentle nudges on your phone exactly when the pot reaches the 'thirst'
                    threshold based on historical weight-to-moisture patterns.
                  </i>
                </div>
                <div className="mt-auto pt-6">
                  <div className="flex items-center gap-2 text-on-secondary-container bg-secondary-container/50 px-4 py-2 rounded-xl">
        ...
        <section
          id="technology"
          className="px-margin-mobile md:px-margin-desktop py-stack-lg bg-surface"
        >
          <div className="max-w-container-max mx-auto">
            <div className="grid lg:grid-cols-2 gap-stack-lg items-center">
              ...
              <div className="flex flex-col gap-6 lg:pl-12 order-1 lg:order-2">
                ...
                <p className="font-body-lg text-body-lg text-on-surface-variant">
                  Our core stack is designed for low latency and high availability. From the sensor
                  to your screen, every byte of weight data is processed with extreme precision and
        ...
        <section className="px-margin-mobile md:px-margin-desktop py-stack-lg bg-navy-navy text-surface overflow-hidden relative">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-10 flex items-center justify-center -z-0">
            <span
              className="material-symbols-outlined text-[600px] text-secondary"
          ...
          <div className="max-w-container-max mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-300 max-w-2xl mx-auto">
                Industry-grade safeguards protecting your growth, data, and identity.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-x-gutter gap-y-16">
              ...
              <div className="flex flex-col gap-6 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-secondary/30 transition-colors">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="font-label-caps text-secondary uppercase tracking-wider text-sm font-semibold">
                    Your privacy is our priority.
                  </p>
                </div>
                <div className="pt-6 flex items-start gap-4 border-t">
                  <span className="material-symbols-outlined text-[80px] leading-none text-secondary">
                    person_off
                  </span>
                  <div>
                    <span className="font-label-caps text-body-lg block mb-1 text-white">
                      Null User Data
                    </span>
                    <p className="text-body-md text-slate-400">
                      Account creation requires only a username and password. Providing an email
                      address is entirely optional.
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 font-body-md text-sm leading-relaxed">
                  Your identity remains fully anonymous. We implement robust security measures to
                  ensure your plant care data remains yours alone, utilizing industry-standard
                  encryption and privacy-first account management.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-secondary/30 transition-colors">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="font-label-caps text-secondary uppercase tracking-wider text-sm font-semibold">
                    Foundational data-minimization rules.
                  </p>
                </div>
                <div className="pt-6 flex items-start gap-4 border-t">
                  <span className="material-symbols-outlined text-[80px] leading-none text-secondary">
                  ...
                  <div>
                    ...
                    <p className="text-body-md text-slate-400">
                      Only if you choose to trust specific device for a faster login experience
                      would device fingerprint be saved.
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 font-body-md text-sm leading-relaxed">
                  Our system is built on a foundation of proactive data protection and user-centric
                  privacy principles. We prioritize minimal data collection in order to maximize
                  your digital safety.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-secondary/30 transition-colors">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="font-label-caps text-secondary uppercase tracking-wider text-sm font-semibold">
                    Fortifying integrity with industrial-grade safeguards.
                  </p>
                </div>
                <div className="pt-6 flex items-start gap-4 border-t">
                  <span className="material-symbols-outlined text-[80px] leading-none text-secondary">
                  ...
                  <div>
                    ...
                    <p className="text-body-md text-slate-400">
                      Ensure that only you can access your account by requiring an MFA verification
                      step via secure standards.
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 font-body-md text-sm leading-relaxed">
                  Best industry-grade top-tier LLMs perform regular automated penetration tests to
                  ensure the highest standards of system resilience and data safety are maintained
              ...
              <div className="flex flex-col gap-6 p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-secondary/30 transition-colors">
                ...
                <div className="pt-6 flex items-start gap-4 border-t">
                  ...
                  <div>
                    ...
                    <p className="text-body-md text-slate-400">
                      Every IoT device operates with a hardened core to ensure data integrity and
                      system resilience from the ground up.
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 font-body-md text-sm leading-relaxed">
                  Our system is built on a foundation of hardware-level security and immutable
                  design principles. We secure the firmware and the communication pipeline at the
                  source, preventing unauthorized access and tampering.
                </p>
              </div>
            </div>
          </div>
