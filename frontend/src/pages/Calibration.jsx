...
export default function Calibration() {
  ...
  return (
    <DashboardLayout title="Calibration">
      ...
      <p>
        Use this section to review watering events that did not reach 100% (min dry + max water
        retained) after repotting.
      </p>
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  {(() => {
                    ...
                    const maxWeight =
                      typeof min === 'number' && typeof maxWater === 'number'
                        ? min + maxWater
                        : null
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {busyPlant === plantId
                            ? 'Correcting...'
                            : 'Correct overfill (since repotting)'}
                        </button>
                      </div>
                    )
                  })()}
                      ...
                      <tbody>
                        {sorted.map((it, idx) => {
                          ...
                          const isMostNegative =
                            isUnder &&
                            (it === mostNegativeEntry ||
                              // Fallback equality by key fields if object identity differs
                              (mostNegativeEntry &&
                                it?.measured_at === mostNegativeEntry?.measured_at &&
                          ...
                          return (
                            <tr
                              ...
                              title={
                                isMostNegative
                                  ? `Most under target by ${Math.abs(diffVal)}g`
                                  : undefined
                              }
                            >
