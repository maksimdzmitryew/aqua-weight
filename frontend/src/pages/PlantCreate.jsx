  ...
  return (
    <DashboardLayout title="Create New Plant">
      ...
      >
        ...
        >
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'general' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
          ...
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'service' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
              border: '1px solid ' + (isDark ? '#444' : '#ccc'),
              borderRadius: '4px',
              cursor: 'pointer',
              color: isDark ? '#fff' : '#000',
          ...
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'care' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
              border: '1px solid ' + (isDark ? '#444' : '#ccc'),
              borderRadius: '4px',
              cursor: 'pointer',
              color: isDark ? '#fff' : '#000',
          ...
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'advanced' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
              border: '1px solid ' + (isDark ? '#444' : '#ccc'),
              borderRadius: '4px',
              cursor: 'pointer',
              color: isDark ? '#fff' : '#000',
          ...
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'health' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
              border: '1px solid ' + (isDark ? '#444' : '#ccc'),
              borderRadius: '4px',
              cursor: 'pointer',
              color: isDark ? '#fff' : '#000',
          ...
          <button
            ...
            style={{
              padding: '10px 15px',
              backgroundColor:
                activeTab === 'calculated' ? (isDark ? '#333' : '#ddd') : isDark ? '#222' : '#eee',
              border: '1px solid ' + (isDark ? '#444' : '#ccc'),
              borderRadius: '4px',
              cursor: 'pointer',
              color: isDark ? '#fff' : '#000',
        ...
        {activeTab === 'general' && (
          <div>
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              {locError && (
                <div style={{ color: 'red', fontSize: '14px', marginTop: '5px' }}>{locError}</div>
              )}
            </div>
          ...
          <div>
            <div style={{ marginBottom: '15px' }}>
              <label
                ...
                htmlFor="recommended_water_threshold_pct"
              >
          ...
          <div>
            ...
            <div style={{ marginBottom: '15px' }}>
              <label
                ...
                htmlFor="substrate_last_refresh_at"
              >
        ...
        {fieldErrors.general && (
          <div style={{ color: 'red', marginBottom: '15px' }}>{fieldErrors.general}</div>
        )}
