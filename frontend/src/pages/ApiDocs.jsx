      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-surface/80 dark:bg-on-background/80 backdrop-blur-md border-b border-outline-variant/30 shadow-sm px-margin-mobile md:px-margin-desktop py-4">
        <div className="max-w-container-max mx-auto flex justify-between items-center h-12">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <Link className="font-label-caps text-label-caps text-on-surface-variant dark:text-outline hover:text-primary transition-colors" to="/">Home</Link>
        ...
        <div className="max-w-container-max mx-auto py-stack-lg">
          ...
          <div className="grid md:grid-cols-2 gap-stack-md">
            <section className="glass-card p-8 rounded-[24px] border border-outline-variant/30">
              <h2 className="font-headline-md text-headline-md mb-4 text-on-surface">Interactive Explorer</h2>
              <p className="text-on-surface-variant mb-6">
                Discover and test our endpoints directly from your browser using our interactive Swagger UI or ReDoc explorers.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href="/api/docs" className="bg-secondary text-on-secondary font-label-caps text-label-caps px-6 py-3 rounded-full hover:shadow-lg transition-all flex items-center gap-2">
                  <span className="material-symbols-outlined">api</span>
                  Swagger UI
                </a>
                <a href="/api/redoc" className="bg-surface border border-outline text-on-surface font-label-caps text-label-caps px-6 py-3 rounded-full hover:bg-surface-container-low transition-all flex items-center gap-2">
            ...
            <section className="glass-card p-8 rounded-[24px] border border-outline-variant/30">
              <h2 className="font-headline-md text-headline-md mb-4 text-on-surface">Base Configuration</h2>
            ...
            <section className="glass-card p-8 rounded-[24px] border border-outline-variant/30">
              <h2 className="font-headline-md text-headline-md mb-4 text-on-surface">Authentication</h2>
              <p className="text-on-surface-variant mb-4">
                We use JWT-based authentication. Include your access token in the Authorization header for all protected requests.
              </p>
              <div className="bg-surface-container-highest p-4 rounded-xl font-label-sm text-label-sm border border-outline-variant/20 overflow-x-auto">
            ...
            <section className="glass-card p-8 rounded-[24px] border border-outline-variant/30">
              <h2 className="font-headline-md text-headline-md mb-4 text-on-surface">Rate Limits</h2>
              <p className="text-on-surface-variant">
                To ensure system stability, we implement fair-use rate limiting. Standard accounts are limited to 1000 requests per hour. 
                Contact support if you need higher limits for industrial applications.
              </p>
            </section>
          </div>
        </div>
